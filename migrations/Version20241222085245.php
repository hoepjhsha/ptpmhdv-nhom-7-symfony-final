 ...
 */
final class Version20241222085245 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE installments (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, payment_id INTEGER NOT NULL, installment_no INTEGER NOT NULL, amount NUMERIC(65, 2) NOT NULL, later_fee NUMERIC(65, 2) NOT NULL, due_date DATETIME NOT NULL, paid BOOLEAN NOT NULL, late_fee NUMERIC(65, 2) NOT NULL, created_at DATETIME NOT NULL, CONSTRAINT FK_FE90068C4C3A3BB FOREIGN KEY (payment_id) REFERENCES payments (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
